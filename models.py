...
# ##        self.created_date = created_date
# ##        self.updated_date = updated_date'''
#     def __init__(self, index,Year_id,ein,objectid,formtype,url,organization,annual_revenue,annual_expenses,number_of_employees,submittedon,fiscal_year_end_date,lastupdated,ready_to_sync,synced_to_sfdc,sfdc_id,sfdc_status,sfdc_err_msg,created_date,updated_date):
...
# class irsTOsfdcIntegration_error_log(db.Model, Serializer):

#     __table__ = db.Model.metadata.tables['irsTOsfdcIntegration_error_log']

#     def __init__(self,EIN_F,Error_Message,index,Year_id,updated_date):
#         self.EIN_F = EIN_F
...
#     def __repr__(self):
#         return 'EIN_F ' + str(self.EIN_F) + ' index ' + str(self.index)
